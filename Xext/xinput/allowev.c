...
/***********************************************************************
 *
 * Function to ellow frozen events to be routed from extension input devices.
 *
 */
